...
"QLabel#settingsStatus[state=\"warning\"] { color: #B45309; font-weight: 800; }"
        ...
        "QLabel#settingsAboutText { color: #475569; font-size: 13px; }"
        "QLabel#settingsAboutText a { color: #0D9488; text-decoration: none; }"
        ...
        "QPushButton#settingsCardRestore {"
        " min-height: 24px;"
        " border-radius: 7px;"
        " padding: 2px 10px;"
        " font-size: 12px;"
        ...
        " color: #475569;"
        "}"
        "QPushButton#settingsCardRestore:hover {"
        " background: #E2E8F0;"
        " border-color: #0D9488;"
        " color: #0F766E;"
        "}"
        "QPushButton#settingsDanger {"
        " min-height: 32px;"
        " border-radius: 9px;"
        ...
        " font-weight: 700;"
        "}"
        "QPushButton#settingsDanger:hover { background: #FEE2E2; border-color: #EF4444; color: #991B1B; }"
...
QString settingsStyleSheet()
{
    ...
    return QStringLiteral(
        ...
        " font-weight: 700;"
        "}"
        "QPushButton#settingsDanger:hover { background: #7F1D1D; border-color: #EF4444; color: #FECACA; }"
